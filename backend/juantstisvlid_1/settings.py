"""
Django settings for juantstisvlid_1 project.
...
ROOT_URLCONF = 'juantstisvlid_1.urls'
...
WSGI_APPLICATION = 'juantstisvlid_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juantstisvlid_1 API",
    "DESCRIPTION": "API documentation for juantstisvlid_1 App",
    "VERSION": "v1",
}
